...
export const LIBRARY_FIELDS: FieldConfig[] = [
  ...
  { key: "cover_url", label: "صورة الغلاف", type: "image" },
  { key: "file_url", label: "رابط الملف", type: "url" },
  {
    key: "category_id",
    label: "التصنيف",
    type: "async-select",
...
// EVENT, MEDIA_CENTER, PARTNER, MEMBERSHIP stay the same — no FK fields
export const EVENT_FIELDS: FieldConfig[] = [
  ...
  { key: "location_type", label: "نوع الفعالية", type: "select", options: [
...
export const MEDIA_CENTER_FIELDS: FieldConfig[] = [
  ...
  { key: "country", label: "الدولة", type: "select", options: [
  ...
  { key: "logo_url", label: "شعار المركز", type: "image" },
...
export const JOURNALIST_FIELDS: FieldConfig[] = [
  ...
  { key: "specialty", label: "التخصص", type: "select", options: [
    { value: "صحافة رقمية", label: "صحافة رقمية" },
    { value: "إعلام مرئي", label: "إعلام مرئي" },
    { value: "صحافة استقصائية", label: "صحافة استقصائية" },
    { value: "إعلام رقمي", label: "إعلام رقمي" },
    { value: "صحافة اقتصادية", label: "صحافة اقتصادية" },
    { value: "صحافة سياسية", label: "صحافة سياسية" },
    { value: "صحافة تقنية", label: "صحافة تقنية" },
    { value: "إنتاج إعلامي", label: "إنتاج إعلامي" },
    { value: "تصوير صحفي", label: "تصوير صحفي" },
  ]},
  { key: "country", label: "الدولة", type: "select", options: [
    { value: "السعودية", label: "السعودية" },
    { value: "الإمارات", label: "الإمارات" },
  ...
  { key: "avatar_url", label: "صورة الإعلامي", type: "image" },
